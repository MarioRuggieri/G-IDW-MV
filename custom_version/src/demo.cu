...
int main(int argc, char **argv)
{
    ...
    {
        printf("Search radius must be 1 or 2!");
        exit (-1);
    }
    ...
    for (int i=0; i<N_BATCH; i++)
    {
        ...
        parallelIDW<<<nBlocks,nThreadsForBlock,shMemSize>>>(devKP_blas, devQP, devW, devKv, devZV, KN, batchDim, stride, nIter, MAX_SHMEM_SIZE, searchRadius);
